...
class SmsHelper {
    ...
    private function getSmsUrl($to,$message) {
        ...
        return $this->url.'action=sendmessage&username='.$this->user.'&password='.$this->password.'&originator='.$this->sender.'&recipient='.$to.'&messagedata='.$message.'&messagetype='.$this->response;
    }
