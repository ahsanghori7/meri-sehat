...
<htmlpageheader name="page-header">
    ...
    <div style="width: 100%; margin-top: 0; line-height: 10px">
        ...
        @if($transaction)
            <p style="font-family: circularstd_light"><span style="font-family: circularstd_book">Patient Name:</span> {{ $transaction->user->name }}</p>
            <p style="font-family: circularstd_light"><span style="font-family: circularstd_book">Consult Type:</span> Instant Video Call</p>
            <p style="font-family: circularstd_light"><span style="font-family: circularstd_book">Date:</span> {{ $transaction->payment_confirmation_date }}</p>
            <p style="font-family: circularstd_light"><span style="font-family: circularstd_book">Amount:</span> {{ $transaction->amount }}</p>
            <p style="font-family: circularstd_light"><span style="font-family: circularstd_book">Payment Type:</span> {{ $transaction->payment_method }}</p>
        @endif
        </div>
    </div>
