...
<div class="modal fade" id="add_videos_details_modal" tabindex="-1" role="dialog"
    ...
    @can('doctor-management-unassign')
    <div class="row mb-3">
...
<script>
    ...
    $('#videos_add_submit').submit(function (event) {
        ...
        var videos_add_url = '{{ route("doctor-update-videos", ":id") }}';
        videos_add_url = videos_add_url.replace(':id', doctor_id);
    ...
    $(document).on('click', '.delete-btn', function(e) {
        ...
        var video_delete_url = '{{ route("doctor-delete-videos", ":id") }}';
        video_delete_url = video_delete_url.replace(':id', doctor_id);
