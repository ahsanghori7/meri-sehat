...
<script>
    ...
    $('#articles_add_submit').submit(function (event) {
        ...
        var articles_add_url = '{{ route("doctor-update-articles", ":id") }}';
        articles_add_url = articles_add_url.replace(':id', doctor_id);
    ...
    $(document).on('click', '.delete-btn', function(e) {
        ...
        var article_delete_url = '{{ route("doctor-delete-articles", ":id") }}';
        data.append( 'recordId',  articleId);
        article_delete_url = article_delete_url.replace(':id', doctor_id);
        swalWithBootstrapButtons.fire({
            title: 'Are you sure?',
