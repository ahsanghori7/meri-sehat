...
{{--                                <div class="col-md-6 mb-3 button_text_div" style="display: block;">--}}
{{--                                    <label for="button_text">Button Text</label>--}}
{{--                                    <input type="text" name="button_text" id="button_text"--}}
{{--                                           value="{{ $result ? $result->button_text : old('button_text') }}" class="form-control button_text"--}}
...
{{--                                           value="{{ $result ? $result->button_link : old('button_link') }}" class="form-control button_text"--}}
{{--                                           placeholder="Enter Button Text">--}}
{{--                                    @error('button_link')--}}
{{--                                    <div class="validation-error"> {{ $message }}</div>--}}
{{--                                    @enderror--}}
{{--                                </div>--}}
                                ...
                                <div class="col-md-12 mb-3 link_div" style="display: block;">
