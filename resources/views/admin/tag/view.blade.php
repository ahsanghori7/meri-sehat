                            ...
                            <tbody class="">
                                ...
                                @foreach ($result as $key => $result)
                                    <tr>
                                        ...
                                        <td>
                                            @can('tags-update')
                                                <a class="btn-primary btn-sm btn cursor-pointer" title="Edit this tag"
                                                   href="{{ route($folder_name.'-edit', ['id' => $result->e_id]) }}"> <i
                                                        class="icon-edit"></i> </a>
                                            @endcan
                                            @can('tags-draft')
                                                <a class="btn-info btn-sm btn cursor-pointer" title="Mark this tag as draft"
                                                   href="{{ route($folder_name.'-mark-draft', ['id' => $result->e_id]) }}"> <i
                                                        class="icon-drafts"></i> </a>
                                            @endcan
                                            @can('tags-goto_live')
                                                <a class="btn-success btn-sm btn cursor-pointer" title="Goto live this tag"
                                                   href="{{ route($folder_name.'-goto-live', ['id' => $result->e_id]) }}"> <i
                                                        class="icon-check"></i> </a>
                                            @endcan
                                            @can('tags-archive')
                                                <a class="btn-danger btn-sm btn cursor-pointer" title="Archive this tag"
