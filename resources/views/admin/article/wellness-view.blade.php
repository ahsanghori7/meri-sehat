...
@section('page_header')
All Wellness {{ Str::plural($module_name) }}
@endsection
@section('content')
            ...
            <div class="col-md-12">
                ...
                <div class="box-header with-border">
                    <div class="d-flex justify-content-start">
                        <a href="{{ route($folder_name . '-wellness-draft-add') }}" class="btn-success btn-sm btn mb-2 cursor-pointer">
                            <i class=" icon-add"></i>
                            Add New
                        </a>
                    </div>
...
<script>
    ...
    function search_start() {
        ...
        $('#yajra').DataTable({
            ...
            , serverSide: true
            , ajax: {
                url: "{{ route('article-wellness-fetch') }}"
                , type: "GET"
                ...
                , {
                    ...
                    , render: function(data, type, row) {
                        ...
                        @can('article-management-draft')
                            btn += ` <a class="btn-info btn-sm my-2 btn cursor-pointer" title="Mark this article as draft" href="${draft_url}"> <i class="icon-drafts"></i></a>`;
                        @endcan
