            ...
            , columns: [{
                ...
                , {
                    ...
                    , render: function(data, type, row) {
                        ...
                        let e_url = ("{{ route('article-edit', ['id' => '-id-']) }}").replace('-id-'
                            , row.e_id);
                        ...
                        @can('article-management-draft')
                            btn += ` <a class="btn-info btn-sm my-2 btn cursor-pointer" title="Draft this article" href="${draft_url}"> <i class="icon-drafts"></i></a>`;
                        @endcan
