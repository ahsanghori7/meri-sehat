                                            ...
                                            <div class="col-md-6">
                                                <div class="card ">
                                                    ...
                                                    <ul class="list-group list-group-flush">
                                                        ...
                                                        <li class="list-group-item"> <strong class="s-12">Role</strong> <span class="float-right s-12">Wellness Experts</span></li>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="card ">
                                                            ...
                                                            <ul class="list-group list-group-flush">
                                                                ...
                                                                <li class="list-group-item"> <strong class="s-12">Source</strong> <span class="float-right s-12">-</span></li>
                                                                <li class="list-group-item"> <strong class="s-12">Role</strong> <span class="float-right s-12">Wellness Expert</span></li>
                                                                <li class="list-group-item"> <strong class="s-12">Created At</strong> <span class="float-right s-12">{{$user->created_at}}</span></li>
                                                            </ul>
                                                        </div>
