...
@section('page_header')
Edit Wellness Experts Educations
@endsection
@php
@endphp
@section('content')
                            ...
                            <div class="row item">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class="form-control badge" name="degree[]">
                                        ...
                                        <option value="{{$degree->id}}" @if($record->degree == $degree->name) selected @endif>{{$degree->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class="form-control badge" name="university[]">
                                        ...
                                        <option value="{{$university->id}}" @if($record->institute == $university->name) selected @endif>{{$university->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
