...
<div class="d-flex align-items-center justify-content-between mb-3">
    ...
    @can('fitness-management-experience-add')
...
@can('fitness-management-experience-list-view')
<table class="table table-striped table-bordered-none" id="experiences_listing">
    ...
    <tbody>
    @if($result->user->fitnessExperiences && count($result->user->fitnessExperiences) > 0)
        @foreach ($result->user->fitnessExperiences as $experience)
            <tr>
                ...
                <td>
                    @can('fitness-management-experience-edit')
                    ...
                    @endcan
                    @can('fitness-management-experience-delete')
...
<script>
    ...
    $(document).on('click', '.experiences_edit', function(event) {
        ...
        var experiences_edit_url = '{{ route("fitness-experts-edit-experiences", ":id") }}';
    ...
    $('#experiences_add_submit').submit(function (event) {
        ...
        var experiences_add_url = '{{ route("fitness-experts-update-experiences", ":id") }}';
        experiences_add_url = experiences_add_url.replace(':id', fitness_experts_id);
    ...
    $(document).on('click', '.experiences_delete', function(e) {
        ...
        var experiences_delete_url = '{{ route("fitness-experts-delete-experiences", ":id") }}';
        data.append( 'recordId',  experienceId);
        experiences_delete_url = experiences_delete_url.replace(':id', fitness_experts_id);
        swalWithBootstrapButtons.fire({
            title: 'Are you sure?',
