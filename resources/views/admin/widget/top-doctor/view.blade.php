                ...
                <div class="col-md-12">
                    <div class="box-header with-border">
                        <div class="d-flex justify-content-start">
                            <a href="{{ route('widget-'.$folder_name.'-add', ['reference_id' => $reference_id, 'reference' => $reference]) }}"
                    ...
                    <form method="post" action="{{ route('widget-'.$folder_name.'-view', ['reference_id' => $reference_id, 'reference' => $reference]) }} ">
                        @csrf
                            ...
                            <tbody class="">
                                ...
                                @foreach ($result as $key => $result)
                                    <tr>
                                        ...
                                        <td>
                                            @can($module_slug.'-widgets-doctor-update')
                                            <a class="btn-primary btn-sm btn cursor-pointer"
                                                href="{{ route('widget-'.$folder_name . '-edit', ['reference_id' => $reference_id, 'reference' => $reference,'id' =>$result->e_id]) }}"> <i
                                                    class="icon-edit"></i> </a>
                                            @endcan
                                        </td>
                                    </tr>
