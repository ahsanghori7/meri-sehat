                        ...
                        <div class="box_border">
                            <div class="row">
                                ...
                                @if (isset($reference))
                                    ...
                                    @can($module_slug.'-widgets-media-heading')
                                    ...
                                    @can($module_slug.'-widgets-media-description')
                                    <div class="col-md-12 px-0 mb-3">
                                    ...
                                    @can($module_slug.'-widgets-media-redirect_url')
                                    <div class="col-md-12 px-0 mb-3">
                                    ...
                                    @can($module_slug.'-widgets-media-ad_window')
                                    <div class="col-md-12 px-0 mb-3">
                                    ...
                                    @endcan
                                @endif
                                @can($module_slug.'-widgets-media-type')
                                        ...
                                        <div id="div_{{$loop->iteration	}}" class="element w-100">
                                            <div class="col-md-12 mb-3 px-0 link">
                                                <div class="row align-items-center px-0">
                                                    @can($module_slug.'-widgets-media-language')
                                                    ...
                                                    @endcan
                                                    @can($module_slug.'-widgets-media-is_default')
                                                    <div class="col-md-3 px-0 link">
                                                    ...
                                                    @endcan
                                                    @can($module_slug.'-widgets-media-add_language')
                                                    <div class="col-md-3 px-0 link">
                                            ...
                                            @can($module_slug.'-widgets-media-media_url')
                                            <div class="col-md-12 mb-3 px-0 link">
                                ...
                                @can($module_slug.'-widgets-media-image')
...
{{--                                        <input type="hidden" name="source" value="{{ isset($result->source) ? $result->source : '' }}"/>--}}
                                ...
                                @endcan
                                @can($module_slug.'-widgets-media-image_alt')
                                <div class="col-md-6 px-0 mb-3 alternative" style="display: none;">
                                    <label for="alt">alternative<span class="text-danger" >*</span> (Alternative information for an image.)</label>
                                ...
                                @endcan
                                @can($module_slug.'-widgets-media-status')
                                ...
                                @endcan
                                @can($module_slug.'-widgets-media-mobile_show')
                                <div class="col-md-6 px-0 mb-3">
                                ...
                                @endcan
                                @can($module_slug.'-widgets-media-web_show')
                                <div class="col-md-6 px-0 mb-3">
                        ...
                        <div class="bg-transparent">
                            @can($module_slug.'-widgets-media-save')
    ...
    <script>
        $(document).ready(function() {
            ...
            if (ref == 'image') {
                ...
                $(".alternative").attr('style', 'display:none');
            }
