            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form method="post" action="{{ route('widget-'.$folder_name . '-index',['reference_id'=>$reference_id]) }} ">
                        @csrf
                        <div>
                            @can($module_slug.'-widgets-disease-heading')
                            ...
                            @endcan
                            @can($module_slug.'-widgets-disease-redirect_url')
                            ...
                            @endcan
                            @can($module_slug.'-widgets-disease-description')
                            ...
                            @endcan
                            @can($module_slug.'-widgets-disease-status')
                            ...
                            @endcan
                            @can($module_slug.'-widgets-disease-mobile_show')
                            <div class="col-md-6 px-0 mb-3 ">
                            ...
                            @endcan
                            @can($module_slug.'-widgets-disease-web_show')
                            <div class="col-md-6 px-0 mb-3 ">
                            ...
                            <tbody class="sortable">
                                ...
                                @foreach ($result as $key => $result)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{asset($result->image)}}" width="100" height="100" alt="">
                                        </td>
                                        <td>
                                            @if ($result->status)
                                        ...
                                        <td>
                                            @can($module_slug.'-widgets-disease-update')
                        ...
                        @can($module_slug.'-widgets-disease-save')
