                        ...
                        <table id="" class="table table-bordered table-hover" style="width:100%;">
                            <thead>
                                <tr>
                                    <th width=" 10px">#</th>
                                    <th class="">Name</th>
                                    <th class="">System Key</th>
                                    <th class="">Web Key</th>
                                    <th class="">Web Image</th>
                                    <th class="">Mobile Key</th>
                                    <th class="">Mobile Image</th>
                                    <th class="">Status</th>
                            ...
                            <tbody class="">
                                ...
                                @foreach ($result as $key => $result)
                                    <tr>
                                        ...
                                        <td> {{ $result->name }}</td>
                                        <td> {{ $result->key }}</td>
                                        <td> {{ $result->web_key }}</td>
                                        <td> <img style="width:120px; height:100px"
                                                src="{{ env('ASSETS_STORAGE'). $result->web_image }}"></td>
                                        <td> {{ $result->mobile_key }}</td>
                                        <td> <img style="width:120px; height:100px"
                                                src="{{ env('ASSETS_STORAGE'). $result->mobile_image }}"></td>
                                        <td>
                                            @if ($result->status)
