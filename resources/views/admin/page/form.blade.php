            ...
            <div class="animated fadeInUpShort">
                <div class="row">
                    ...
                    <div class="col-md-8 pr-0">
                        @if ($result)
                            <div class="wrap">
                                <iframe src="{{ $path }}" class="frame" id="iView" frameborder="0">
                                </iframe>
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-12 ">
                            <div class="box_border">
                                <div class="row">
                                    ...
                                    @if ($result)
                                        <div class="col-md-2">
                                            <span>
                                                <a class="btn-primary btn-sm my-2 btn cursor-pointer" title="Open Live Preview"
                                    ...
                                    @can('default-page-general-info-name')
                                    ...
                                    @can('default-page-general-info-slug')
                                        <div class="col-md-12 mb-3">
                                    ...
                                    @can('default-page-general-info-speciality_tag')
                                    ...
                                    {{-- <div class="col-md-12" @if ($result) style="display: none;" @endif>
                                        <div class="mb-3">
                                            <label for="type">Type</label>
                                            <select class="form-control parent_type" name="reference_type" id="type"
                                                required>
                                                @foreach ($types as $type)
                                                    <option value="{{ $type['value'] }}"
                                                        @if ($result) @if ($result->reference_type == $type['value'])
                                                selected @endif
                                                        @endif>
                                                        {{ $type['name'] }}</option>
                                                @endforeach
                                        ...
                                        <div class="mb-3 parents_div"
                                            @if ($result) style="display: none;" @endif>
                                            <label for="parent">Parent</label>
                                            <select class="form-control parents" name="reference_id" id="parent">
                                                @if ($parents)
                                                    @foreach ($parents as $parent)
                                                        <option value="{{ $parent->id }}"
                                                            @if ($result) @if ($result->reference_id == $parent->id)
                                                selected @endif
                                                            @endif>
                                                            {{ $parent->name ?? ($parent->title ?? '') }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                            @error('parent')
                                    ...
                                    @can('default-page-general-info-keywords')
                                        <div class="col-md-12 mb-3">
                                            <label for="keywords">Keywords</label>
                                            <input type="text" name="keywords" id="keywords"
                                                   value="{{ $result ? $result->keywords : old('keywords') }}"
                                                   class="form-control" placeholder="Enter Keywords" required>
                                            @error('keywords')
                                            <div class="validation-error"> {{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    @can('default-page-general-info-description')
                                        <div class="col-md-12 mb-3">
                                            <label for="descripton">Description</label>
                                            <textarea name="descripton" id="descripton" class="form-control" required placeholder="Description">{{ $result ? $result->descripton : old('descripton') }}</textarea>
                                            @error('descripton')
                                            <div class="validation-error"> {{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    @can('default-page-general-info-description')
                                        <div class="col-md-12 mb-3" style="display: flex; justify-content: end;">
                                            <label for="is_description_show">
                                                <input class="form-control-input" name="is_description_show" id="" type="checkbox" value="1"
                                                       @if($result && $result->is_description_show == 1) checked @endif> Show Text on Banner
                                            </label>
                                        </div>
                                    @endcan

                                    @can('default-page-general-info-category')
                                        <div class="col-md-12 mb-3">
                                    ...
                                    @can('default-page-general-info-sub_category')
                                        <div class="col-md-12 mb-3">
                                    ...
                                    @if ($result && $result->reference_type != 'page')

                                        @can('default-page-general-info-reviewed_by')
                                            <div class="col-md-12 mb-3 reviewed_by_doctor">
                                                <label for="reviewed_by">Reviewed By</label>
                                                <select class="form-control" id="reviewed_by" name="reviewed_by_doctor">
                                                    <option value=""> Select Doctor </option>
                                                    @foreach ($doctors as $doctor)
                                                        <option value="{{ $doctor['id'] }}" {{ isset($result->reviewed_by) && $result->reviewed_by == $doctor['id'] ? 'selected' : '' }} >
                                                            {{ $doctor['name'] }}</option>
                                                    @endforeach
                                                </select>
                                                @error('approved_by')
                                        ...
                                        @can('default-page-general-info-reviewed_by')
                                            <div class="col-md-12 mb-3 reviewed_by_wellness">
                                                <label for="reviewed_by">Reviewed By</label>
                                                <select class="form-control" id="reviewed_by" name="reviewed_by_wellness">
                                                    <option value=""> Select Wellness </option>
                                                    @foreach ($wellness_profiles as $wellness_profile)
                                                        <option value="{{ $wellness_profile['id'] }}" {{ isset($result->reviewed_by) && $result->reviewed_by == $wellness_profile['id'] ? 'selected' : '' }}>
                                        ...
                                        {{--                                        <div class="col-md-12 mb-3">--}}
                                        {{--                                            <label for="type">Reviewed By</label>--}}
                                        {{--                                            <select class="form-control" name="reviewed_by">--}}
                                        {{--                                                <option value=""> Select Doctor </option> </option>--}}
                                        {{--                                                @foreach ($doctors as $doctor)--}}
                                        {{--                                                    <option value="{{ $doctor['id'] }}"--}}
                                        {{--                                                        @if ($result) @if ($result->reviewed_by == $doctor['id'])--}}
                                        {{--                                                selected @endif--}}
                                        {{--                                                        @endif>--}}
                                        {{--                                                        {{ $doctor['name'] }}</option>--}}
                                        {{--                                                @endforeach--}}
                                        ...
                                        @can('default-page-general-info-written_by')
                                            <div class="col-md-12 mb-3">
                                        ...
                                        @can('default-page-general-info-tags')
                                            <div class="col-md-12 mb-3">
                                                <label for="tags">Tags</label>
                                                <select class="token_tags form-control" multiple="multiple" name="tags[]"
                                                        id="tags">
                                                    @foreach ($tags as $tag)
                                    ...
                                    @can('default-page-general-info-image')
                                        <div class="col-md-12 mb-2 px-4">
                                            <label for="image">Image <span class="text-danger">*</span> (Dimensions : 1920 X 400 px) </label>
                                            <input type="file" data-max-file-size="2M" name="image" id="image"
                                                   value="{{ isset($result->image) ? env('ASSETS_STORAGE').$result->image : null }}"
                                                   data-default-file="{{ isset($result->image) ? env('ASSETS_STORAGE').$result->image : '' }}"
                                                   class="dropify" crossorigin="anonymous">
                                            @error('image')
                                            <div class="validation-error"> {{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    @can('default-page-general-info-image_alt')
                                    ...
                                    @if ($result)
                                        @can('default-page-widgets-add')
                                            <div class="col-md-12 mb-3">
                                                <button type="button" class="btn btn-info" data-toggle="modal"
                                                        data-target="#myModal">See/Add available widgets</button>
                                            </div>
                                        @endcan
                                    @endif

                                    @can('default-page-general-info-meta_name')
                                        <div class="col-md-12 mb-3">
                                    ...
                                    @can('default-page-general-info-meta_description')
                                        <div class="col-md-12 mb-3">
                                    ...
                                    @can('default-page-general-info-canonical_title')
                                        <div class="col-md-12 mb-3">
                                    ...
                                    @can('default-page-general-info-canonical_description')
                                        <div class="col-md-12 mb-3">
                                    ...
                                    @can('default-page-general-info-canonical_link')
                                    <div class="col-md-12 mb-3">
                                    ...
                                    @can('default-page-general-info-seo_image')
                                    <div class="col-md-12 mb-3">
                                        <label for="seo_image">SEO image url</label>
                                        <textarea class="form-control" maxlength="1000" id="seo_image" name="seo_image" placeholder="Enter seo image url">{{ $result ? $result->seo_image : old('seo_image') }}</textarea>
                                        @error('seo_image')
                                        <div class="validation-error"> {{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    @can('default-page-general-info-hidden_description')
                                    <div class="col-md-12 mb-3">
                                    ...
                                    @can('default-page-general-info-enable_disable')
                                        <div class="col-md-12">
                                            @include('general_crud.status_radio')
                                        </div>
                                    @endcan

                                    @can('default-page-general-info-is_featured')
                                        <div class="col-md-12">
                                            <div class="col-md-6 px-0 mb-2">
                                                <label for="status" class="d-block">Is Featured?</label>
                                                ...
                                                <div class="custom__radio mb-3">
                                                    <div class="d-flex box p-0 justify-content-between form-check">
                                                        <div class="w-100">
                                                            <input class="form-check-input" name="is_featured" type="radio" {{isset($result->is_featured) == 1 ? 'checked' : '' }} value="1" id="is_featured_yes">
                                                            <label class="form-check-label" for="is_featured_yes">
                                                                Yes
                                                            </label>
                                                        </div>
                                                        <div class="w-100">
                                                            <input class="form-check-input" type="radio" name="is_featured" value="0" {{isset($result->is_featured) == 0 ? 'checked' : '' }} id="is_featured_no">
                                    ...
                                    @can('default-page-general-info-class_name')
                                        <div class="col-md-12 mb-3">
                            ...
                            <div class="bg-transparent">
                                @can('default-page-general-info-save')
                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="row">
                                        ...
                                        <div class="gallery-card">
                                            <div class="gallery-card-body">
                                                <label class="block-check d-flex">
                                                    <img src="{{ env('ASSETS_STORAGE'). $widget->web_image }}"
                                                ...
                                                <label for="count_widgets">
                                                    <input type="number" class="form-control" name="count_widgets[]" id="count_widgets">
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            @endif
                            @if ($result)
                                @php $articleWidgets = $result->pageWidgets->pluck('widget_id')->toArray(); @endphp
                                @foreach ($widgets as $widget)
                                    @can('default-page-widgets-'.$widget->key.'-add')
            ...
            <div class="box_border">
                ...
                <form method="post" id="update_sequence" action="{{ route('article-update_sequence') }}">
                    ...
                    <table id="" class="table table-bordered table-hover" style="width:100%;">
                        ...
                        @php $articleWidgets = $result->pageWidgets; @endphp
                        @foreach ($articleWidgets as $articleWidget)
                            <tr>
                                ...
                                <td>
                                    <div class="gallery-card" style="width: 25% !important">
                                        <div class="gallery-card-body">
                                            <label class="d-flex">
                                                <img src="{{ env('ASSETS_STORAGE'). $articleWidget->widget->web_image }}"
                                                     class="img-responsive" crossorigin="anonymous"/>
                                            </label>
                                            <div class="mycard-footer text-center">
                                ...
                                <td>
                                    @can('default-page-widgets-'.$articleWidget->widget->key.'-update')
                                        <button class="cst_btn-outline btn-sm cursor-pointer" type="button"
                                                onclick="open_module_modal_{{ $articleWidget->widget_id }}({{ $articleWidget->id }})">
                                            <i class="icon-edit"></i> </button>
                                    @endcan
                                    @can('default-page-widgets-'.$articleWidget->widget->key.'-delete')
                                        <a onclick="return confirm('Are you sure you want to delete?')" class="cst_btn-outline btn-sm cursor-pointer"
                                           href="{{route('page-delete-widget', ['reference_id' => $articleWidget->id]) }}">
                    ...
                    @can('default-page-widgets-update')
...
@push('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.reviewed_by_doctor').hide();
            $('.reviewed_by_wellness').hide();
            if ($(".category option:selected" ).text() == 'Wellness') {
                $('.spectiality_tag').hide();
                $('.reviewed_by_doctor').hide();
                $('.reviewed_by_wellness').show();
            } else {
                $('.spectiality_tag').show();
                $('.reviewed_by_doctor').show();
                $('.reviewed_by_wellness').hide();
            }
            ...
            $('.parent_type').change(function() {
                let parent_type = $(this).val();
                if (parent_type == "page") {
                    $('.parents_div').slideUp();
                } else {
                    $('.parents_div').slideDown();
                }
                populateParents(parent_type);
            })

            function populateParents(type) {
                $('#loader').show();
                $.ajax({
                    url: "{{ route('page-get-parent-by-type') }}",
                    type: 'GET',
                    data: {
                        type,
                        '_token': '{{ csrf_token() }}'
