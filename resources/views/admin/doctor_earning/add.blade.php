...
<div class="container">
    <div class="row">
        <div class="col-md-6 col-sm-12">
            ...
            @isset($transaction)
            <form action="{{ route('doctor-payout-appointments-add') }}" method="POST" id="transaction-from" class="my-4 p-3">
                @csrf
                ...
                <div class="form-group row">
                    <div class="col-md-4">
                        <label for="doctor_name">Bank Transaction ID: <span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="bank_transaction_id" id="bank_transaction_id">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-4">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $("#doctor_name").change(function(){
                ...
                var id = $(this).val();
                var url = '{{ route("doctor-payout-appointments", ":id") }}';
