                    ...
                    <div class="box_border">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select id="role" name="role" required class="form-control role">
                                    ...
                                    @foreach ($roles as $key => $role)
                                        <option value="{{ $role->id }}" @if ($result)  @if ($result->role_id == $role->id) selected @endif @endif>{{ $role->name }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('role')<div class="validation-error"> {{ $message }}</div> @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <span class="show_password p-2" style="cursor:pointer"><i class="icon-eye"></i></span>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="custom__radio mb-3">
                                    <div class="d-flex box p-0 justify-content-between form-check">
                                        <div class="w-100">
                                            <input class="form-check-input" name="status" type="radio" @if ($result)  @if ($result->status) checked @endif
                                            @else checked @endif
                                            value="1" id="enable">
                    ...
                    <div class="box_border pb-1 px-0">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12 px-4 mb-3">
                                <input type="file" data-max-file-size="2M" name="image" id="image" value="{{ isset($result->image) ? env('ASSETS_STORAGE').$result->image : null }}"
                                ...
                                @error('image')<div class="validation-error"> {{ $message }}</div> @enderror
                            </div>
                        </div>
