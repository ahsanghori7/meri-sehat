...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin/css/wickedpicker.css') }}" />
    @stack('css')
    <style>
        .loader {
            position: fixed;
        ...
        button.swal2-confirm.btn.btn-success:focus {
            box-shadow: none;
        }
        #add_shifts_details_modal.modal, #edit_shifts_details_modal.modal {
            overflow: visible !important;
        }
        #add_services_details_modal.modal, #edit_services_details_modal.modal {
            overflow: visible !important;
        }
        #add_specialities_details_modal.modal, #edit_specialities_details_modal.modal {
            overflow: visible !important;
        }
        #add_educations_details_modal.modal, #edit_educations_details_modal.modal {
            overflow: visible !important;
        }
        #add_videos_details_modal.modal {
            overflow: visible !important;
        }
...
<body class="light">
        ...
        <div class="page has-sidebar-left">
            ...
            <div class="navbar navbar-expand d-flex navbar-dark justify-content-between bd-navbar blue accent-3 shadow d-print-none">
                ...
                <li>
                    <div class="mt-1">
                        ...
                        <div class="float-left info mt-1">
                            <h6 class="font-weight-light mt-2 mb-1 pr-4" style="color: white">{{ Auth::user()->name }}</h6>
                        </div>
                    </div>
                </li>
                ...
                <li class="dropdown custom-dropdown user user-menu ">
                    <a href="#" class="nav-link" data-toggle="dropdown">
                        {{-- <img src="{{ env('ASSETS_STORAGE').Auth::user()->image }}" width="25" height="25" class="user-image" alt="User Image"> --}}
                        <i class="icon-more_vert " style="color:white; z-index:9999;"></i>
                    </a>
                    <div class="dropdown-menu p-0 m-0 dropdown-menu-right">
                        <div class="list-group mt-3 shadow">
                            {{-- <a href="{{ route('updateProfile') }}" --}}
                            <a href="{{ route('updateProfile') }}" class="list-group-item list-group-item-action ">
                                <i class="mr-2 icon-cogs text-blue"></i>
                                Update Profile
                            </a>
                            {{-- <a href="{{ route('change_password') }}" --}}
                            <a href="{{ route('manage-password') }}" class="list-group-item list-group-item-action ">
                                <i class="mr-2 icon-cogs text-blue"></i>
                                Change Password
                            </a>
    ...
    <script src="//cdnjs.cloudflare.com/ajax/libs/jcarousel/0.3.9/jquery.jcarousel.min.js"></script>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.fill_questionaire', function() {
                let id = $(this).data('id');
                let url = ("{{route('appointment-get_questionaire_form',['-id-'])}}").replace('-id-', id)
            ...
            function setActions(callBack, moveUpCallback, moveDownCallback, addCallback, deleteCallback) {
                ...
                var template = '<div class="infosec"><button><img class="dragUp" src="' + arrowImgAsset +
                    '" alt="dragUp" onclick="parent.' + moveUpCallback + '" /></button><div><a onclick="parent.' + callBack +
